...
### Rainy Day Tasks
A new task type for tasks you want to save for "someday" without any time or location constraints:

- **New "💧 Rainy Day" tab** in Add Task screen
- **Category labels**: Fun, Work, School, Home Improvement, Social, Wellbeing, Spiritual
- **Custom labels**: Add your own labels with the custom input field
- **New "RD Tasks" button** in bottom navigation with water droplet icon
- **Dedicated Rainy Day screen** showing all rainy day tasks grouped by label
- **Quick actions**: Promote to "Do It Now", mark complete, or delete
- **Syncs with PC version** via Firebase

### iOS Support & Responsiveness
- **Safe area insets** for notched iPhones (iPhone X and later)
- **Touch-friendly targets** (minimum 44px tap areas)
- **Responsive layouts** for iPhone SE through iPhone Pro Max
- **iPad optimization** with centered content
- **iOS PWA fixes**: Prevents text zoom, fixes input focus issues
